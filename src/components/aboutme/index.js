                    ...
                    <div className="artBio">
                      ...
                      <h4>
                        <i>
                            ...
                            animations. I also dabble in film, photography and
          ...
          <TabPanel className="tabpanel">
            <div className="resume">
              <div className="top-inner-resume">
                <h2 id="resname">Devin Baldwin</h2>
                <img
                  className="avatar"
                  src="https://i.imgur.com/i3gUs1M.jpg?1"
                  alt="avatar"
                />
                <h2>
              ...
              <div className="inner-resume-container">
                <div className="left-inner-resume">
                  ...
                  <div className="skillsImages">
                    <img
                      className="skillsImg"
                      src="https://i.imgur.com/q3rccdB.png"
                      alt="bond"
                    />
                    <img
                      className="skillsImg"
                      src="https://i.imgur.com/vPE2m5i.png"
                      alt="random"
                    />
                    <img
                      className="skillsImg"
                      src="https://i.imgur.com/s5M0KEk.png"
                      alt="doom"
                    />
                    <img
                      className="skillsImg"
                      src="https://i.imgur.com/mJfrnKZ.png"
                      alt="powerup"
                    />
                    <img
                      className="skillsImg"
                      src="https://i.imgur.com/3jgTazr.png"
                      alt="tdc"
                    />
                    <img
                      className="skillsImg"
                      src="https://i.imgur.com/PIT2B79.png"
                      alt="random1"
                    />
                    <img
                      className="skillsImg"
                      src="https://i.imgur.com/tXp0OIC.png"
                      alt="doom1"
                    />
                    <img
                      className="skillsImg"
                      src="https://i.imgur.com/F7AcpuI.png"
                      alt="powerup1"
                    />
                    <img
                      className="skillsImg"
                      src="https://i.imgur.com/4VDGdwS.png"
                      alt="tdc1"
                    />
                    <img
                      className="skillsImg"
                      src="https://i.imgur.com/e9GJOxI.png"
                      alt="blender"
                    />
                  </div>
                </div>
                ...
                <div className="right-inner-resume">
                  ...
                  <h4>
                    ...
                    queries
                    <br />  -Web Tools, UI Frameworks, Preprocessors: CSS, LESS,
                    SASS, SCSS
                    <br />
